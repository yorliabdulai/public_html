...
?>
    ...
    <section class="cover overflow-hidden bg-primary inverted">
     ...
     <section class="py-10 border-bottom bg-light">
        <div class="container">
                ...
                <div data-carousel='{"gutter": 48, "loop": false, "nav": false, "controls": false, "responsive": {"0": {"items": 2}, "768": {"items": 4}, "1200": {"items": 5}}}'>
                    <div>
                        <a href="https://inqoins.io" target="_blank">
                            <img src="assets/media/sponsors/inqoins.png" alt="Logo" class="logo">
                        </a>
                    </div>
                    <div>
                        <a href="https://www.fedi.xyz/" target="_blank">
                            <img src="assets/media/sponsors/fedi.jpg" alt="Logo" class="logo">
                        </a>
                    </div>
                    <div>
                        <a href="https://bitafrika.com/" target="_blank">
                            <img src="assets/media/sponsors/bitafrika.jpg" alt="Logo" class="logo">
                        </a>
                    </div>
                    <!--<div>-->
                    <!--    <a href="https://fluus.com/" target="_blank">-->
                    <!--        <img src="assets/media/sponsors/fluus.jpg" alt="Logo" class="logo">-->
                    <!--    </a>-->
                    <!--</div>-->
                    <div>
                        <a href="https://www.ottochain.io/ " target="_blank">
                            <img src="assets/media/sponsors/ottochain.jpg" alt="Logo" class="logo">
                        </a>
                    </div>
                    <div>
                        <a href="https://www.betcoin.ag/ " target="_blank">
                            <img src="assets/media/sponsors/betcoin.png" alt="Logo" class="logo">
                        </a>
                    </div>
                </div>
            </div>
